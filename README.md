...
HappyCamper is a Java desktop application designed to help camp leaders analyze and manage activity assignments for campers. 
The application provides a user-friendly interface for importing, analyzing, and exporting roster data. Analysis feature enable camp leaders to quickly detect scheduling oversights, honor preferences, and ensure a safe experience for all participants.
...
HappyCamper's feature-based, service-oriented architecture allows for easy extension and maintenance, and lets users load, analyze, and export the information most relevant to them.
...
- Feature implementations: `ActivityFeature`, `ProgramFeature`, `MedicalFeature`, `PreferenceFeature`
...
- Filter implementations: `SortedProgramFilter`, `AssignmentFilter`
...
- Exception handling: `RosterException`
- Warning management: `WarningManager`, `RosterWarning`
- Detailed error reporting: `DetailedRosterException`
...
```bash
java -jar target/happy-camper-2.1-SNAPSHOT.jar
```
