    ...
    public void loadFromCSV(File file) throws RosterException {
        try (CSVParser parser = ImportUtils.createSafeParser(file);) {
            ...
            if (parsedHeaders.isEmpty()) {
                throw RosterException.create_normalWrapper("No headers found in file", null);
            }
            ...
            throw RosterException.create_normalWrapper("Error loading CSV file: " + e.getMessage(), e);
        }
    }
}
