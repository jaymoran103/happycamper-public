...
public class RosterService {
    ...
    public EnhancedRoster createEnhancedRoster(File camperFile, File activityFile, List<String> enabledFeatureIds){
        ...
        try {
            ...
            FileValidator.validateCSVFile(camperFile, null); // Required headers are checked by individual features
            FileValidator.validateCSVFile(activityFile, null);
            ...
            RosterException exceptionWrapper = RosterException.create_normalWrapper("RosterService.createEnhancedRoster: " + e.getMessage(), e);
    ...
    public void exportRoster(EnhancedRoster roster, FilterManager filterManager, ExportSettings settings) throws RosterException {
        try {
            ...
            throw RosterException.create_normalWrapper("RosterService.exportRoster: " + e.getClass().getName(), e);
        }
    }
