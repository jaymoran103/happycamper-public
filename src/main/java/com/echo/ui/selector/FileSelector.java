...
public class FileSelector extends InputSelector<File> {
    ...
    private ExportFileValidator.ValidationResult validationResult;
    ...
    protected void buildSelectorPanel(JPanel panel) {
        ...
        JButton browseButton = new JButton(BUTTON_TEXT);
     ...
     */
    public ExportFileValidator.ValidationResult getValidationResult() {
        return validationResult;
    }


    private void doValidation(){
        ExportFileValidator.ValidationResult result;
        if (selectedFile==null){
            result = ExportFileValidator.ValidationResult.failure("No file selected");
        } else if (mode == SelectionMode.SAVE && extensions != null && extensions.length > 0) {
            result = ExportFileValidator.validateExportFile(selectedFile, extensions);
        } else {
            result = ExportFileValidator.ValidationResult.success();
        }
