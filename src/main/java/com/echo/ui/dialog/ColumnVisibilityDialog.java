...
public class ColumnVisibilityDialog extends InputsDialog {
     ...
     */
    private static void sizeColumnsToFitContent(JTable table) {
     ...
     *
     * @param table The table to reset column widths for
     */
    private static void resetColumnWidths(JTable table) {
        for (int column = 0; column < table.getColumnCount(); column++) {
            table.getColumnModel().getColumn(column).setPreferredWidth(75);
        }
    }
