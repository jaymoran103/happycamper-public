...
public class DetailedErrorPanel extends ErrorPanel {
    ...
    private JComponent createTableComponent(DetailedRosterException detailedRosterException) {
        ...
        System.out.println("Calculated table height: " + tableHeight + " for " + dataRows.length + " rows");

        // Create a dimension with standard width but dynamic height
        Dimension tableDimension = new Dimension(DialogConstants.WARNINGTABLE_WIDTH, tableHeight);
    ...
    public int calculatePreferredHeight() {
        ...
        System.out.println("DetailedErrorPanel height: " + totalHeight + " (text: " + textHeight + ", table: " + tableHeight + ")");
