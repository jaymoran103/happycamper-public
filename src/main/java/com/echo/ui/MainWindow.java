...
public class MainWindow extends JFrame {
    ...
    public MainWindow(RosterService rosterService) {
        ...
        JLabel welcomeLabel = new JLabel("<html><div style='text-align: center;'><h2>Welcome to "+RosterApplication.NAME_VERSION+"</h2>" +
                "<p>Click 'Import' to get started.</p></div></html>");
    ...
    private JPanel createControlPanel() {
        ...
        JButton viewSettingsButton = new JButton("View Settings");
        viewSettingsButton.addActionListener(this::handleViewSettings);

        JButton columnVisibilityButton = new JButton("Column Visibility");
    ...
    private void handleExport(ActionEvent event) {
        if (currentRoster == null) {
            JOptionPane.showMessageDialog(this, "No roster to export", "Export Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
